...
export const MULTISIG_TESTCASES: TestCase[] = [
  {
    idx: 0,
    account: new NoCheckAccount(AccountType.Multisig, 2, 2, [addressToBuffer(pubKey0, 0)]),
  ...
  {
    idx: 1,
    account: new NoCheckAccount(AccountType.Multisig, 2, 4, [
  ...
  {
    idx: 2,
    account: new NoCheckAccount(AccountType.Multisig, 3, 4, [
      addressToBuffer(pubKey0, 0),
      addressToBuffer(pubKey3, 3),
      addressToBuffer(pubKey2, 2),
    ]),
